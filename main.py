...
# ============================================================================
# 구역 4. 일관객 합계 TOP 10 영화 (가로 막대 그래프)
# ============================================================================
...
pivot = (
    ...
    .reindex(columns=WEEKDAY_ORDER)  # 월요일 ~ 일요일 순서 고정
    .sort_index()  # 월(1~12) 순서 고정
)
...
fig5.update_traces(
    hovertemplate="월: %{y}<br>요일: %{x}<br>관객 합계: %{z:,}명<extra></extra>"
)
